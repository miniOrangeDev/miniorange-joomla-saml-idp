        ...
        function() {
            function n(e) {
                ...
                this._options = t.extend({
                    ...
                    delay: !1,
                    basePath: "",
                    template: '<div class="mo2f_popover" role="tooltip"> <div class="mo2f_arrow" ></div> <h3 class="mo2f_popover-header" style="margin-top:0px;"></h3> <div class="mo2f_popover-body"></div> <div class="mo2f_popover-navigation"> <div class="mo2f_tour_btn-group"> <button class="mo2f_tour_btn mo2f_tour_btn-sm mo2f_tour_btn-secondary mo2f_tour_btn_next-success" data-role="prev">&laquo; Prev</button>&nbsp; <button class="mo2f_tour_btn mo2f_tour_btn-sm mo2f_tour_btn-secondary mo2f_tour_btn_next-success" data-role="next">Next &raquo;</button> <button class="mo2f_tour_btn mo2f_tour_btn-sm mo2f_tour_btn-secondary" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div>&nbsp;&nbsp; <button class="mo2f_tour_btn mo2f_tour_btn-sm mo2f_tour_btn-secondary mo2f_tour_btn_next-success" data-role="end">End tour</button> </div> </div>',
